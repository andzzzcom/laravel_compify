@extends("Admin.incl.layout")
		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">List Pages</h4>
				</div>
									...
									<tbody>
										...
										@foreach($list as $page)
											<tr>
												...
												<td>
													<a href="{{url('admin/pages/edit', $page->id_page)}}"><i class="fa fa-edit fa-2x"></i> </a>
												</td>
											</tr>
										@php
											$i = $i + 1
	...
	<script>
		...
		{
			var t = $('#_token').val();
			var c = confirm("Are you sure delete this Page?");
			if(c == true){
				$.ajax({
					headers:{
						'X-CSRF-TOKEN': t
					},
					url:'{{ url("admin/pages/delete_act") }}',
					type:"POST",
					data: {id:id},

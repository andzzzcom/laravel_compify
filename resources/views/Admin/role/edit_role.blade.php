@extends("Admin.incl.layout")
	...
	<div class="page-wrapper">
		...
		<div class="container-fluid">
			...
			<!-- Start Page Content -->
			<!-- Row -->
			<form class="form p-t-20" method="post" enctype="multipart/form-data" action="{{ url('admin/role/edit_act') }}">
				@csrf
				<input type="hidden" name="id" value="{{ $edit[0]->id_role }}"> 
				<div class="row">
					<div class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="name" class="form-control" value="{{ $edit[0]->name }}" placeholder="Role Name" aria-label="Name Role" aria-describedby="basic-addon1">
									</div>
								</div>		
								...
								<a href="{{ url('admin/role') }}" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Cancel</a>
							</div>
						</div>
					</div>
				</div>

		...
		<div class="container-fluid">
			...
			<div class="row page-titles">
				<div class="col-md-5 align-self-center">
					<h4 class="text-themecolor">Add Menu</h4>
				</div>
			...
			<!-- Start Page Content -->
			<!-- Row -->
			<form class="form p-t-20" method="post" enctype="multipart/form-data" action="{{ url('admin/role/menu/add_act') }}">
				@csrf
				<div class="row">
					<div class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input required type="text" name="name" class="form-control" placeholder="Name Menu" aria-label="Name Menu" aria-describedby="basic-addon1">
									</div>
								</div>		
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input required type="text" name="url" class="form-control" placeholder="URl Menu" aria-label="URL Menu" aria-describedby="basic-addon1">
									</div>
								</div>		

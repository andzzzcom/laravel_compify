@extends("Admin.incl.layout")
	...
	<div class="page-wrapper">
		...
		<div class="container-fluid">
				...
				<div class="col-md-7 align-self-center text-right">
					<div class="d-flex justify-content-end align-items-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="{{ url('admin/blog') }}">Gallery</a></li>
			...
			<!-- Start Page Content -->
			<!-- Row -->
			<form class="form p-t-20" method="post" enctype="multipart/form-data" action="{{ url('admin/blog/add_act') }}">
				@csrf
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="title" class="form-control" placeholder="Title Blog" aria-label="Title Blog" aria-describedby="basic-addon1">
									</div>
								</div>		
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										<textarea style="width:100%;height:500px" id="textareas" name="content" class="form-control" placeholder="Content Blog" aria-label="Content Blog" aria-describedby="basic-addon1"></textarea>
									</div>
								</div>			
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<select name="id_blog_category" class="form-control custom-select">
											@foreach($cat as $c)
												<option value="{{$c->id_blog_category}}">{{$c->name}}</option>
											@endforeach
										</select>
									 </div>
								</div>
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="tag" class="form-control" placeholder="Tag Blog" aria-label="Tag Blog" aria-describedby="basic-addon1">
									</div>
								</div>		

@extends("Admin.incl.layout")
	...
	<div class="page-wrapper">
		...
		<div class="container-fluid">
			...
			<!-- Start Page Content -->
			<!-- Row -->
			<form class="form p-t-20" method="post" enctype="multipart/form-data" action="{{ url('admin/product/add_act') }}">
				@csrf
				<div class="row">
					<div class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="name" class="form-control" placeholder="Insert Name" aria-label="Name Product" aria-describedby="basic-addon1">
									</div>
								</div>					
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="description" class="form-control" placeholder="Insert Description" aria-label="Description Product" aria-describedby="basic-addon1">
									</div>
								</div>						
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" name="price" class="form-control" placeholder="Insert Price" aria-label="Price Product" aria-describedby="basic-addon1">
									</div>
								</div>	
